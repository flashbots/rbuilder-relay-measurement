    ...
    if data:
        ...
        for i, builder_data in enumerate(builder_data_list):
            ...
            if builder_data['builder_pubkey'] == winner_data['builder_pubkey']:
                ...
                break
            print(f"Value difference: {int(winner_data['value']) - int(builder_data['value'])}")
            print(f"Gas used difference: {int(winner_data['gas_used']) - int(builder_data['gas_used'])}")
            print(f"Num_tx difference: {int(winner_data['num_tx']) - int(builder_data['num_tx'])}")
            print(f"Timestamp difference: {int(winner_data['timestamp_ms']) - int(builder_data['timestamp_ms'])}")
